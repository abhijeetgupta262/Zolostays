...
public class UsersDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + UsersPersistenceContract.UserEntry.TABLE_NAME + " (" +
                    UsersPersistenceContract.UserEntry.COLUMN_NAME_PHONE_NUMBER + TEXT_TYPE + " PRIMARY KEY," +
                    UsersPersistenceContract.UserEntry.COLUMN_NAME_USER_ID + TEXT_TYPE + COMMA_SEP +
                    ...
                    UsersPersistenceContract.UserEntry.COLUMN_NAME_PASSWORD + TEXT_TYPE +
            " )";
